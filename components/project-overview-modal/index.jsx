...
export default function ProjectOverviewModal({ project, gradient = "bg-gradient-to-br from-gray-200 to-gray-300" }) {
    ...
    return (
        <div className="w-full h-full bg-zinc-100 relative">
            <div className={classNames("w-full h-64 flex flex-col justify-center items-center px-4", gradient)}>
